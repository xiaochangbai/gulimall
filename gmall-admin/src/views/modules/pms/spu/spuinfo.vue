<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="categoryId" header-align="center" align="center" label="所属分类"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getDataList(all) {
      ...
      this.$http({
        url: this.$http.adornApiUrl('/pms/spu/category/' + (this.all === 0 ? this.catId : 0)),
        method: "get",
